...
function AlphabaticLoader({ onComplete, onUpdate }: AlphabaticLoaderProps) {
  ...
  return (
    <div
      id="InitialLoader"
      ref={Ref}
      className="fixed z-[60] flex flex-col justify-center items-center top-0 left-0 w-full h-full bg-gradient-to-r from-[#2c5364] via-[#203a43] to-[#0f2027]"
    >
      <div className="flex justify-center items-center ">
        <svg id="SVG" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 446 512">
      ...
      <h3
        id="MadeBy"
        className="opacity-0 text-2xl text-white pt-3 tracking-wider"
      >
      ...
      <h1
        id="Name"
        className="opacity-0 text-4xl text-white pt-3 tracking-widest "
      >
        Khaled Ghonim
      </h1>
    </div>
