  ...
  return (
    <div className="flex w-full h-full z-30 absolute inset-0 justify-center items-center px-10">
      <div
        ...
        className="w-5 h-5 rounded-full border-4 border-[#18FFFF]"
      ></div>
      <div className="flex-1 flex flex-col text-center pt-14 ">
        <h1
          id="first"
          className="text-lg text-[#18FFFF] tracking-wider font-bold"
        >
          The Rebel Alliance
        </h1>
        <h1 id="second" className="text-5xl font-extrabold tracking-widest">
          Stand Aganist The Evil
        </h1>
        <div className="flex justify-between gap-2 pt-10 w-8/12 mx-auto">
          <div className="flex gap-2">
            <h1 id="third" className=" tracking-wide text-lg">
              & Restore
            </h1>
          ...
          <h1 id="fourth" className=" tracking-wide text-lg">
            the Republic
          </h1>
        </div>
      </div>
